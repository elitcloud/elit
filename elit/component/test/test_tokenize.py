...
class TestEnglishTokenizer(unittest.TestCase):
    ...
    def test_symbol(self):
        ...
        test(self, ".1 +1 -1 1,000,000.00 1,00 '97 '90s '1990 10:30 1:2 a:b",
        ...
        test(self, "aa;;;b: c\"\"d\"\" 0'''s ''a''a'' 'a'a'a'.?!..",
        ...
        # currency like
        test(self, '#happy2018,@Jinho_Choi: ab@cde #1 $1 ',
             ['#happy2018', ',', '@Jinho_Choi', ':', 'ab@cde', '#', '1', '$', '1'],
             [(0, 10), (10, 11), (11, 22), (22, 23), (24, 30), (31, 32), (32, 33), (34, 35), (35, 36)])

        # hyphen
        test(self, "1997-2012,1990's-2000S '97-2012 '12-14's",
    ...
    def test_concat(self):
        ...
        test(self, "'CAUSE 'tis ' em 'happy",
             ["'CAUSE", "'tis", "'em", "'", 'happy'],
             [(0, 6), (7, 11), (12, 16), (17, 18), (18, 23)])

        # abbreviation
        test(self, 'A.B. a.B.c AB.C. Ph.D. 1.2. A-1.',
             ['A.B.', 'a.B.c', 'AB.C', '.', 'Ph.D.', '1.2.', 'A-1.'],
             [(0, 4), (5, 10), (11, 15), (15, 16), (17, 22), (23, 27), (28, 32)])

        # acronym
        test(self, 'ab&cd AB|CD 1/2 a-1 1-2',
             ['ab&cd', 'AB|CD', '1/2', 'a-1', '1-2'],
             [(0, 5), (6, 11), (12, 15), (16, 19), (20, 23)])

        # hyphenated
        test(self, 'mis-predict mic-predict book - able book-es 000-0000 000-000-000 p-u-s-h-1-2',
