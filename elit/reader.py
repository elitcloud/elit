...
def tsv_to_pos(tokens, word_index=0, pos_index=1):
    return NLPGraph([NLPNode(word=t[word_index], pos=t[pos_index]) for t in tokens])

def tsv_to_dep(tokens, word_index=1, lemma_index=2, pos_index=3, feats_index=4, head_index=5, deprel_index=6):
