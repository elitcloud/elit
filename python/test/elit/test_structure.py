...
# ========================================================================
import unittest
from elit.structure import NLPNode, NLPGraph
...
class StructureTest(unittest.TestCase):
    def test_nlpnode_ancestor(self):
        ...
        self.assertTrue(nodes[3].child_of(nodes[0]))
        self.assertTrue(nodes[8].child_of(nodes[10]))
